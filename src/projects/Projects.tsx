export const projectsList = [
  {
    name: "Gamer Gear",
    description: "Full-stack informercial site for gaming peripherals, visitors are able to see which gaming peripherals are currently dominating the market by game and used by the most professional players in the E-Sports scene. Built on NextJS with ReactTS.",
    url: "https://gamer-gear.vercel.app/home",
    imageURL: "../assets/gamer_gear_collage.png"
  },
  {
    name: "What's Brewin'",
  ...
  },
  {
    ...
    description: 'A simple 2D "Point and Shoot" game built with vanilla JS, HTML and CSS as an exercise in collision detection, delta time, and array data structures.',
    url: "https://github.com/StanSurj98/Point_n_Shoot_2D_JS_Game",
    imageURL: "../assets/2d_point_n_shoot.png"
  },
  {
